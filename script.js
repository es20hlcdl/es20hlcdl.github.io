...
function initScrollSpy() {
    ...
    const trackedSections = [
        ...
        { section: document.querySelector('#courses'), targetId: '#courses' },
...
const translations = {
    es: {
        ...
        "courses-intro": "Formación aplicada en sistemas de información geográfica, catastro multifinalitario, geodesia, cartografía digital y gestión territorial, conectando teoría, herramientas tecnológicas y problemas reales del territorio.",
        "courses-status-soon": "Próximamente",
        "courses-info-link": "Solicitar información",
        "course-1-title": "Catastro Multifinalitario y Desarrollo Urbano",
        "course-1-desc": "Curso orientado a comprender, estructurar y aplicar el catastro multifinalitario como sistema de información territorial para la planificación urbana, la gestión municipal y la formulación de políticas públicas.",
        "course-1-tag-1": "Catastro",
        "course-1-tag-2": "SIG",
        "course-1-tag-3": "Gestión territorial",
        "course-2-title": "QGIS aplicado al Catastro",
        "course-2-desc": "Curso práctico para estructurar información catastral, trabajar con GeoPackage, analizar cobertura de servicios públicos, generar mapas temáticos y preparar información para la toma de decisiones.",
        "course-2-tag-1": "QGIS",
        "course-2-tag-2": "GeoPackage",
        "course-2-tag-3": "Análisis espacial",
        "course-3-title": "Procesamiento GNSS con GAMIT/GLOBK",
        "course-3-desc": "Curso introductorio al procesamiento de datos GNSS, redes de control, coordenadas precisas, series temporales y análisis geodésico aplicado a estaciones de operación continua.",
        "course-3-tag-1": "GNSS",
        "course-3-tag-2": "GAMIT/GLOBK",
        "course-3-tag-3": "Geodesia",
        "course-4-title": "Cartografía Web y StoryMaps",
        "course-4-desc": "Curso orientado al diseño de mapas web, geoportafolios, narrativas territoriales y productos digitales para comunicar información geográfica de forma clara, visual y profesional.",
        "course-4-tag-1": "Mapas web",
        "course-4-tag-2": "StoryMaps",
        "course-4-tag-3": "Comunicación territorial",
    ...
    en: {
        ...
        "courses-intro": "Applied training in geographic information systems, multipurpose cadastre, geodesy, digital cartography and territorial management, connecting theory, technological tools and real-world territorial challenges.",
        "courses-status-soon": "Coming soon",
        "courses-info-link": "Request information",
        "course-1-title": "Multipurpose Cadastre and Urban Development",
        "course-1-desc": "Course focused on understanding, structuring and applying multipurpose cadastre as a territorial information system for urban planning, municipal management and public policy formulation.",
        "course-1-tag-1": "Cadastre",
        "course-1-tag-2": "GIS",
        "course-1-tag-3": "Territorial management",
        "course-2-title": "QGIS Applied to Cadastre",
        "course-2-desc": "Practical course to structure cadastral information, work with GeoPackage, analyze public service coverage, generate thematic maps and prepare information for decision-making.",
        "course-2-tag-1": "QGIS",
        "course-2-tag-2": "GeoPackage",
        "course-2-tag-3": "Spatial analysis",
        "course-3-title": "GNSS Processing with GAMIT/GLOBK",
        "course-3-desc": "Introductory course on GNSS data processing, control networks, precise coordinates, time series and geodetic analysis applied to continuously operating stations.",
        "course-3-tag-1": "GNSS",
        "course-3-tag-2": "GAMIT/GLOBK",
        "course-3-tag-3": "Geodesy",
        "course-4-title": "Web Cartography and StoryMaps",
        "course-4-desc": "Course focused on designing web maps, geoportfolios, territorial narratives and digital products to communicate geographic information clearly, visually and professionally.",
        "course-4-tag-1": "Web maps",
        "course-4-tag-2": "StoryMaps",
        "course-4-tag-3": "Territorial communication",
